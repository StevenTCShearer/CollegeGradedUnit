...
namespace ValueFurniture.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        /// </summary>
        /// <param name="searchStringUserNameOrEmail">Search for a specific user</param>
        /// <param name="currentFilter">Holds searchStringUsernameOrEmail</param>
        /// <param name="page">Number of Pges needed</param>
        /// <returns>
        /// List of all users
        /// </returns>
        ...
        /// Creates a User
        /// </summary>
        /// <param name="paramExpandedUserDTO">Details to Create User</param>
        /// <returns>
        /// Admin Index
        /// </returns>
        [Authorize(Roles = "Administrator")]
        ...
        public ActionResult Create(ExpandedUserDTO paramExpandedUserDTO)
        {
            try
            {
                ...
                // Create user
                var objNewAdminUser = new ApplicationUser { UserName = UserName, Email = Email, FirstName = FirstName, Surname = Surname, PhoneNumber = PhoneNumber, EmailConfirmed = true };
        ...
        /// Edit a User
        /// </summary>
        /// <param name="UserName">Identitfier of User to change</param>
        /// <returns></returns>
        [Authorize(Roles = "Administrator")]
        ...
        /// </summary>
        /// <param name="paramExpandedUserDTO">Details that have been changed</param>
        /// <returns></returns>
        [Authorize(Roles = "Administrator")]
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        /// </summary>
        /// <param name="UserName">Username of User to change Role of</param>
        /// <returns></returns>
        [Authorize(Roles = "Administrator")]
        ...
        /// Edit Role of a User
        /// </summary>
        /// <param name="paramUserAndRolesDTO">User getting edited</param>
        /// <returns></returns>
        [Authorize(Roles = "Administrator")]
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        /// <param name="RoleName">Name of Role to Remove</param>
        /// <returns></returns>
        [Authorize(Roles = "Administrator")]
        ...
        /// <summary>
        /// Getting the Roles as a Select List
        /// </summary>
        /// <returns></returns>
        ...
        /// Return a User
        /// </summary>
        /// <param name="paramUserName">Username of User to return</param>
        /// <returns></returns>
        ...
        /// Update DTO User
        /// </summary>
        /// <param name="paramExpandedUserDTO">User to Update</param>
        /// <returns></returns>
        /// <exception cref="Exception">Could not find the User
        /// or</exception>
        private ExpandedUserDTO UpdateDTOUser(ExpandedUserDTO paramExpandedUserDTO)
        {
            ...
            if (!string.IsNullOrEmpty(paramExpandedUserDTO.FirstName))
            {
                result.FirstName = paramExpandedUserDTO.FirstName;
            }
            if (!string.IsNullOrEmpty(paramExpandedUserDTO.Surname))
            {
                result.Surname = paramExpandedUserDTO.Surname;
            }
            if (!string.IsNullOrEmpty(paramExpandedUserDTO.PhoneNumber))
            {
        ...
        /// Delete a User
        /// </summary>
        /// <param name="paramExpandedUserDTO">User to Delete</param>
